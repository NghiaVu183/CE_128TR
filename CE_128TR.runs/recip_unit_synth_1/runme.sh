...
HD_PWD='E:/CE_128TR/CE_128TR.runs/recip_unit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log recip_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source recip_unit.tcl
