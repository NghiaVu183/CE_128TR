...
HD_PWD='E:/CE_128TR/CE_128TR.runs/div_gen_frac_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_gen_frac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_gen_frac.tcl
