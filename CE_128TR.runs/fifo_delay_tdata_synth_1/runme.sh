...
HD_PWD='E:/CE_128TR/CE_128TR.runs/fifo_delay_tdata_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_delay_tdata.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_delay_tdata.tcl
