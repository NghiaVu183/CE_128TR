...
HD_PWD='E:/CE_128TR/CE_128TR.runs/cordic_rot_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_rot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_rot.tcl
