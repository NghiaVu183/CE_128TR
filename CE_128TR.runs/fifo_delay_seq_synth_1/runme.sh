...
HD_PWD='E:/CE_128TRx/CE_128TR.runs/fifo_delay_seq_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_delay_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_delay_seq.tcl
