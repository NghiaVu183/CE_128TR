...
HD_PWD='E:/CE_128TR/CE_128TR.runs/sin_cos_lp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sin_cos_lp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sin_cos_lp.tcl
