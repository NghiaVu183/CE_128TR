...
#
# Script generated by Vivado on Thu Jun 25 23:59:09 +0700 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_delay_demap.sh
...
#
# Usage        : fifo_delay_demap.sh
#                fifo_delay_demap.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_delay_demap.sh [-reset_run]
#                fifo_delay_demap.sh [-reset_log]
#                fifo_delay_demap.sh [-help]
#
...
# script info
echo -e "fifo_delay_demap.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_delay_demap.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_delay_demap xil_defaultlib.fifo_delay_demap xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_delay_demap -key {Behavioral:sim_1:Functional:fifo_delay_demap} -tclbatch cmd.tcl -protoinst "protoinst_files/CE_128TR.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_delay_demap.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_delay_demap.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_delay_demap.sh [-help]\n\
Usage: fifo_delay_demap.sh [-step]\n\
Usage: fifo_delay_demap.sh [-lib_map_path]\n\
Usage: fifo_delay_demap.sh [-reset_run]\n\
Usage: fifo_delay_demap.sh [-reset_log]\n\
Usage: fifo_delay_demap.sh [-keep_index]\n\
Usage: fifo_delay_demap.sh [-noclean_files]\n\n\
