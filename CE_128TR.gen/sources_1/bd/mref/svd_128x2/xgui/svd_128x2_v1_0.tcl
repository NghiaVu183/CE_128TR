...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "N_PAR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "N_ROW" -parent ${Page_0}


}

proc update_PARAM_VALUE.N_PAR { PARAM_VALUE.N_PAR } {
	# Procedure called to update N_PAR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.N_PAR { PARAM_VALUE.N_PAR } {
	# Procedure called to validate N_PAR
	return true
}
...
proc update_MODELPARAM_VALUE.N_PAR { MODELPARAM_VALUE.N_PAR PARAM_VALUE.N_PAR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.N_PAR}] ${MODELPARAM_VALUE.N_PAR}
}
