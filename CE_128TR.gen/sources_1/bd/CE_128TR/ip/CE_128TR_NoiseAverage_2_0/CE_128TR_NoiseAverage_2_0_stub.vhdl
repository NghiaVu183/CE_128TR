...
-- Date        : Tue Jun 23 23:36:30 2026
-- Host        : LAPTOP-55KNS8Q0 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               e:/CE_128TR/CE_128TR.gen/sources_1/bd/CE_128TR/ip/CE_128TR_NoiseAverage_2_0/CE_128TR_NoiseAverage_2_0_stub.vhdl
-- Design      : CE_128TR_NoiseAverage_2_0
...
entity CE_128TR_NoiseAverage_2_0 is
  Port ( 
    clk : in STD_LOGIC;
    rstn : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of CE_128TR_NoiseAverage_2_0 : entity is "CE_128TR_NoiseAverage_2_0,NoiseAverage,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of CE_128TR_NoiseAverage_2_0 : entity is "CE_128TR_NoiseAverage_2_0,NoiseAverage,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=NoiseAverage,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,PARA=16}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of CE_128TR_NoiseAverage_2_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of CE_128TR_NoiseAverage_2_0 : entity is "module_ref";
end CE_128TR_NoiseAverage_2_0;

architecture stub of CE_128TR_NoiseAverage_2_0 is
