...
//               e:/CE_128TR/CE_128TR.gen/sources_1/bd/CE_128TR/ip/CE_128TR_ChannelNorm_1_0/CE_128TR_ChannelNorm_1_0_stub.v
...
(* CHECK_LICENSE_TYPE = "CE_128TR_ChannelNorm_1_0,ChannelNorm,{}" *) (* CORE_GENERATION_INFO = "CE_128TR_ChannelNorm_1_0,ChannelNorm,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=ChannelNorm,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,PORT=2,DIN_W=16,NOISE_W=32,FRAC_W=16}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "ChannelNorm,Vivado 2024.2" *) 
module CE_128TR_ChannelNorm_1_0(clk, rst_n, aveg_corr_valid, aveg_noise_valid, 
